                ...
                <div id="tooplate_content" >
                    ...
                    <form name="user-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        <table border="0" cellspacing="10" cellpadding="10" align="center" width="600">
                            ...
                            <td  bgcolor="#F0F8FF">
                                <input type="text" name="first_name" size="50" class="heighttext" value="<?php echo $first_name; ?>"/>
                            ...
                            <td>
                                <input type="text" name="middle_name" size="50" class="heighttext" value="<?php echo $middle_name; ?>" />
                            ...
                            <td bgcolor="#F0F8FF">
                                <input type="text" name="last_name"  size="50" class="heighttext" value="<?php echo $last_name; ?>" />
                            ...
                            <td>
                                <input type="text" name="appointment" size="50" class="heighttext" value="<?php echo $appointment; ?>"/>
                            ...
                            <td bgcolor="#F0F8FF">
                                <input type="text" name="email"  size="50" class="heighttext" value="<?php echo $email; ?>"/>
                            ...
                            <td >
                                <input type="text" name="username" value="" size="50" class="heighttext" value="<?php echo $username; ?>" />
